...
import com.example.taskmanager.databinding.FragmentEditNoteBinding
...
class EditNoteFragment : Fragment(R.layout.fragment_edit_note), MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        radioLow = binding.radioLow
        radioMedium = binding.radioMedium
        radioHigh = binding.radioHigh
        ...
        binding.editNoteFab.setOnClickListener{
            ...
            val noteDate = binding.editNoteDesc.text.toString().trim()
            val priority = when {
                binding.radioLow.isChecked -> "Low"
                binding.radioMedium.isChecked -> "Medium"
                binding.radioHigh.isChecked -> "High"
                else -> ""
            }


            if(noteTitle.isNotEmpty()){
                val note = Note(currentNote.id, noteTitle, noteDesc, noteDate, priority)
